    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("1127bb5c-d9da-4655-a4a3-f947590c9605"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("6a1f6bb1-8989-4b20-b5f8-6aa446f93511"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("a38d31ae-ed3a-4c2d-ae46-38ba087ce71d"));
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    RecurringExpenseID1 = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Expenses_RecurringExpenses_RecurringExpenseID1",
                        column: x => x.RecurringExpenseID1,
                        principalTable: "RecurringExpenses",
                        principalColumn: "RecurringExpenseID");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Expenses_RecurringExpenseID1",
                table: "Expenses",
                column: "RecurringExpenseID1");
